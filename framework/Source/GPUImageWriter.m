...
- (void)setAssetWriterAudioInputBuffer:(AVAssetWriterInput *)assetWriterAudioInputBuffer
{
    _assetWriterAudioInputBuffer = assetWriterAudioInputBuffer;
    assetWriterAudioInput = assetWriterAudioInputBuffer;
}
...
// 为了 MP4 也有音频，不在这设置 assetWriterAudioInput（因为 MP4 的视频需要设置 AVAssetWriterInput 的 formatDescriptions）
